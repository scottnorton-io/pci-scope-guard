# Complete GitHub Repository Files

# Complete GitHub Repository Files

**All files needed for GitHub publication**
...
[![Python 3.11+]([https://img.shields.io/badge/python-3.11+-blue.svg)](https://www.python.org/downloads/)](https://img.shields.io/badge/python-3.11+-blue.svg)](https://www.python.org/downloads/))
[![Code style: black]([https://img.shields.io/badge/code%20style-black-000000.svg)](https://github.com/psf/black)](https://img.shields.io/badge/code%20style-black-000000.svg)](https://github.com/psf/black))
...
See [Deployment Guide](docs/guides/[deployment.md](http://deployment.md)) for detailed instructions.

---

## Documentation

- [Architecture Overview](docs/architecture/[system-design.md](http://system-design.md))
- [Installation Guide](docs/guides/[installation.md](http://installation.md))
- [User Guide](docs/guides/[user-guide.md](http://user-guide.md))
- [API Reference](docs/api/[rest-api.md](http://rest-api.md))
- [Integration Guides](docs/integrations/)
- [PCI DSS Mapping](docs/compliance/[pci-dss-mapping.md](http://pci-dss-mapping.md))
- [Assessor Guide](docs/compliance/[assessor-guide.md](http://assessor-guide.md))
...
See [AWS Integration Guide](docs/integrations/[aws.md](http://aws.md)) for detailed permissions.

---

## Contributing

Contributions are welcome! Please see [[CONTRIBUTING.md](http://CONTRIBUTING.md)]([CONTRIBUTING.md](http://CONTRIBUTING.md)).
...
- 📧 Email: [scott@johansonllp.com](mailto:scott@johansonllp.com)
- 🐛 Issues: [GitHub Issues]([https://github.com/scottnorton-io/pci-scope-guard/issues](https://github.com/scottnorton-io/pci-scope-guard/issues))
- 💬 Discussions: [GitHub Discussions]([https://github.com/scottnorton-io/pci-scope-guard/discussions](https://github.com/scottnorton-io/pci-scope-guard/discussions))
...
Built with:
- [FastAPI]([https://fastapi.tiangolo.com/](https://fastapi.tiangolo.com/)) - Modern Python web framework
- [SQLAlchemy]([https://www.sqlalchemy.org/](https://www.sqlalchemy.org/)) - Database ORM
- [TimescaleDB]([https://www.timescale.com/](https://www.timescale.com/)) - Time-series PostgreSQL
- [boto3]([https://boto3.amazonaws.com/v1/documentation/api/latest/index.html](https://boto3.amazonaws.com/v1/documentation/api/latest/index.html)) - AWS SDK
- [cryptography]([https://cryptography.io/](https://cryptography.io/)) - Cryptographic signing

Inspired by the need to make PCI DSS compliance less painful for cloud-native organizations.

---

**Built with ❤️ by [Scott Norton]([https://github.com/scottnorton-io)**](https://github.com/scottnorton-io)**)
```

[Docker & Deployment Files](Complete%20GitHub%20Repository%20Files/Docker%20&%20Deployment%20Files%207d221b4bd01547feafade75a206e8f28.md)

[GitHub Publication Checklist & Final Summary](Complete%20GitHub%20Repository%20Files/GitHub%20Publication%20Checklist%20&%20Final%20Summary%200f67d691ee1343e8b73a9d66c1229e8c.md)

[Integration Guides - AWS, Azure, GCP, GRC Platforms](Complete%20GitHub%20Repository%20Files/Integration%20Guides%20-%20AWS,%20Azure,%20GCP,%20GRC%20Platform%200d757606cbc34eff8f057faad9b330ce.md)

[Compliance Documentation - PCI DSS Mapping & Assessor Guide](Complete%20GitHub%20Repository%20Files/Compliance%20Documentation%20-%20PCI%20DSS%20Mapping%20&%20Asses%20de7bc125ec49439c95fec0b4e0563501.md)

[Developer Guides - Testing, Contributing, API Development](Complete%20GitHub%20Repository%20Files/Developer%20Guides%20-%20Testing,%20Contributing,%20API%20Deve%20dded5be4ad71426a81259a83b68868ce.md)

[CI/CD Pipeline - GitHub Actions Workflows](Complete%20GitHub%20Repository%20Files/CI%20CD%20Pipeline%20-%20GitHub%20Actions%20Workflows%209711a3c458804a8b966f810dbd033607.md)